...
export const findPropertyPath = (propertyIndex, property) => {
  ...
  let refSize = tags[1][0] != null ? 1 : 0;
  let bindingsSize = tags[1][1] ? 1 : 0;
  let hashSize = tags[1][2] != null ? 1 : 0;
  let statsSize = tags[1][3] != null ? 1 : 0;
  let nodeSize = tags[1][4] != null ? 1 : 0;
  ...
  } else if (absoluteIndex < hashStop) {
    idx = [2];
  } else if (absoluteIndex < statsStop) {
    idx = [3];
...
export class TagPath {
  ...
  get nextSibling() {
    ...
    switch (propertyIndex0) {
      ...
      case 2:
      case 3: {
        let tagPath = TagPath.from(path, tagsIndex, propertyIndex + 1);
        if (tagPath) {
          return tagPath;
        }
        // fallthrough
