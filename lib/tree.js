...
import { getPrototypeOf, isPlainObject } from '@bablr/helpers/object';
...
function* __streamFromTree(rootNode, options) {
  ...
  if (!rootNode_ || !sumtree.getSize(rootNode_.children)) return;

  let tagPath = TagPath.fromNode(rootNode_, 0);
