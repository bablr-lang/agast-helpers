...
export const addProperty = (node, property) => {
  ...
  if (isInitializer) {
    ...
    node.tags = Tags.push(
      ...
      buildChild(
        Property,
        buildPropertyWrapper(tags, buildProperty(reference, null, isArrayInitializer ? [] : null)),
      ),
    );
  ...
  node.tags = Tags.push(node.tags, buildChild(Property, buildPropertyWrapper(tags, property)));
