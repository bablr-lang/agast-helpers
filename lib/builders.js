...
// export const buildProperty = (tags, reference, bindings = [], node = null, shift = null) => {
//   if (!isArray(tags)) throw new Error();
...
//   return freeze({ tags, reference, bindings, node, shift });
// };
