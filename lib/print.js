...
export const printBinaryString = (binaryString) => {
  let { type, value } = binaryString;

  switch (type) {
    case BinaryStringTag:
      return `b${printString(value)}`;
    default:
      throw new Error('not implemented');
  }
};

export const printBinaryStringTag = (tag) => {
  return printBinaryString(tag.value);
};
...
const printers = {
  ...
  [BinaryStringTag]: printBinaryStringTag,
