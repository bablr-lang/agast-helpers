...
import { arrayLast, freeze, freezeRecord, isPlainObject } from './object.js';
import { maybeWait } from './iterable.js';
import { arrayValues, isRecord } from '@bablr/record';
...
function* __generateCSTML(tags, options) {
  ...
  let prevTag = null;
  let iter = getStreamIterator(groupTags(hoist(tags), { porcelain: pcl }));
  let step;
  let indentLevel = 0;
  let inline = false;
  let ref = null;
