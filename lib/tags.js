...
const valueBreaksHash = (hash, value) => {
  return hashesBreak(hash, stepGearHashValue(value, hash));
};
...
const splice_ = (idx, removeCount, insertValues, tree) => {
  ...
  for (let d = depth; d > 0; d--) {
    ...
    let hash = idx_ && gearHash16At(idx_ - leadingPulldowns.length, tree); // 0 42627 62345 53891 37555
