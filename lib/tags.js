...
export const getIndex = (pathSegment, tags) => {
  ...
  let counts = buildCounts(nodeIsRoot(tags) ? tags[1][1] : tags);
...
export const buildCounts = (node) => {
  let { refsSums } = getSums(node);
  if (refsSums) {
    return refsSums;
  }
